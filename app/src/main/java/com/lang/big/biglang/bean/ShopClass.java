...
public class ShopClass {
    ...
    private static ShopClass shopClass2;
    ...
    private ShopClass(Context context, final Handler mUIHandler) {
    ...
    public static ShopClass getShopClass2(Context context, Handler mUIHandler) {
        if (shopClass2 == null) {
            shopClass2 = new ShopClass(context, mUIHandler);
        }else{
